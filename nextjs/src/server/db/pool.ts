...
// A module-level singleton `Pool` is safe (and desired) in Next.js's
// long-lived Node.js server runtime — same as it was for the standalone
// Express process. Only relevant on the server: this file must never be
// imported from a Client Component (route handlers / Server Actions only).
